...
def _compile_mode_report(
    ...
    *,
    ...
    return {
        ...
        'topology_cache_hit': metrics.get('topology_cache_hit'),
        'topology_cache_miss': metrics.get('topology_cache_miss'),
        'topology_source': metrics.get('topology_source'),
        'topology_freshness': metrics.get('topology_freshness'),
        'topology_node_count': metrics.get('topology_node_count'),
        'topology_repo_shape': metrics.get('topology_repo_shape'),
        'topology_primary_node': metrics.get('topology_primary_node'),
        'topology_selected_node_count': metrics.get('topology_selected_node_count'),
        'topology_selection_confidence': metrics.get('topology_selection_confidence'),
        'topology_selection_ambiguous': metrics.get('topology_selection_ambiguous'),
        'topology_selection_fallback_used': metrics.get('topology_selection_fallback_used'),
